...
export default function AddUserManually() {
    ...
    function insertOrder(e) {
        ...
        if (shipping === '' || email === '' || firstname === '' || lastname === '' || address === '' || postalcode === '' || city === '' || phone === '') {
            ...
            <div className="col-sm-12 col-md-12 col-lg-12">
                ...
                <form onSubmit={insertOrder}>
                        ...
                        <div className="tokatTiedot">
                            <input className="form-group col-md-4" value={email} onChange={e => setEmail(e.target.value)} placeholder='Asiakkaan sähköposti...' />
